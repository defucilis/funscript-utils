...
exports.getHalfSpeedScript = exports.getHalfSpeedGroup = exports.getActionGroups = void 0;
var sign = function (val) {
    if (val === 0)
        return 0;
    return val > 0 ? 1 : -1;
};
exports.getActionGroups = function (actions) {
    var actionGroups = [];
    var index = -1;
    var timeSinceLast = -1;
...
exports.getHalfSpeedGroup = function (actionGroup, options) {
...
exports.getHalfSpeedScript = function (script, options) {
